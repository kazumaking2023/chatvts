...
$('#messages').append('<div class="partner"> Hãy chờ để được kết nối đến người lạ! Nếu quá lâu, hãy tải lại trang!   </div>');
...
socket.on('partner', function (partner_data) {
    if(partner_id==null){
        $('#messages').append("<div>"+'Đã kết nối với '+partner_data.username+"</div>");
